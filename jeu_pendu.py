...
# ----------- Paramètre de mise en route du programme
continuer_programme = 1

# ----------- Renvoie une chaîne de caractère qui contient l’alphabet
alphabet = string.ascii_lowercase

# ----------- Boucler sur le choix du joueur de continuer ou non
while continuer_programme == 1:
    ...
    # ----------- Permettre au joueur de continuer ou de quitter le jeu
    continuer_programme = int(input("Voulez vous recommencer ? entrez '1' pour OUI / '2' pour QUITTER : \n"))
